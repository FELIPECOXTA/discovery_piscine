...
# call the shrink method on it; if the argument has less than eight characters, call the enlarge method on it; and if the argument has exactly eight characters, display
